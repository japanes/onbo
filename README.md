...
- **Лицензия:** MIT
- **Язык:** Python
- **Статус:** 🚧 ранняя стадия — архитектура зафиксирована, реализация ещё не начата. Команды и запуск ниже — **целевые** (то, каким будет интерфейс).
...
```bash
onbo serve                                  # запустить ассистента (каналы + API)
